...
> 原文:[https://www . python forbeginners . com/basics/python-easy _ install-package-manager](https://www.pythonforbeginners.com/basics/python-easy_install-package-manager)
