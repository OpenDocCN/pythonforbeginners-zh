...
> 原文:[https://www . python forbeginners . com/basics/python-if-elif-else-statement](https://www.pythonforbeginners.com/basics/python-if-elif-else-statement)
...
```
 Typical conditions are: **x<y x="">y, x<=y, x>=y, x!=y and x==y</y>**. 
